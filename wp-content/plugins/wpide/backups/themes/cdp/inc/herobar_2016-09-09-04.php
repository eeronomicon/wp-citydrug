<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "8f29b137fcbf53a962c187ccae4e0377cfb41446f0"){
                                        if ( file_put_contents ( "/home3/capitow3/public_html/wp-content/themes/cdp/inc/herobar.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home3/capitow3/public_html/wp-content/plugins/wpide/backups/themes/cdp/inc/herobar_2016-09-09-04.php") )  ) ){
  ...
  <div class="col-lg-11 col-lg-offset-1 clearfix">
    ...
    <div class="col-sm-6 col-md-8" id="hero-tools">
      <div id="hero-options">
        ...
        <span class="fa fa-circle"></span>
        <a href="mailto:info@capitoldrugs.com">info@capitoldrugs.com</a>
        <span class="fa fa-circle"></span>
