<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "8f29b137fcbf53a962c187ccae4e037765b613c05a"){
                                        if ( file_put_contents ( "/home3/capitow3/public_html/wp-content/themes/cdp/inc/herobar.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home3/capitow3/public_html/wp-content/plugins/wpide/backups/themes/cdp/inc/herobar_2016-12-20-18.php") )  ) ){
...
<div id="<?php echo $barclass; ?>">
  <div class="col-lg-11 col-lg-offset-1 clearfix">
    <div class="col-sm-6 col-md-4" id="hero-logo">
      ...
      <span class="text-center"><?php echo get_bloginfo('description' ); ?></span>

      <?php if(get_field('logo_sub_text', 'option')): ?>
      <div class="list-unstyled" style="color: white; margin-top: 10px; font-size: 120%;">
