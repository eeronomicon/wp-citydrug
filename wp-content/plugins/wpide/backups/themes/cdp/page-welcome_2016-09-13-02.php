<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "8f29b137fcbf53a962c187ccae4e037777762f05f0"){
                                        if ( file_put_contents ( "/home3/capitow3/public_html/wp-content/themes/cdp/page-welcome.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home3/capitow3/public_html/wp-content/plugins/wpide/backups/themes/cdp/page-welcome_2016-09-13-02.php") )  ) ){
...
<header id="hp-hero"  class="clearfix">
  ...
  <?php
 mail('shadowdrakkeen@gmail.com', 'Test Subject', 'Test Message');
