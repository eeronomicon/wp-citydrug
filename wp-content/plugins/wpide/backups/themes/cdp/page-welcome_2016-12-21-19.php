<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "8f29b137fcbf53a962c187ccae4e0377837f2d6953"){
                                        if ( file_put_contents ( "/home3/capitow3/public_html/wp-content/themes/cdp/page-welcome.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home3/capitow3/public_html/wp-content/plugins/wpide/backups/themes/cdp/page-welcome_2016-12-21-19.php") )  ) ){
...
<header id="hp-hero"  class="clearfix">
  ...
  <article class="lyt-center clearfix" style="background: #DBE6ED; padding: 50px;">
    ...
    <div class="col-lg-8 col-lg-offset-2 content nopad" style="color: #132A49 !important;">
