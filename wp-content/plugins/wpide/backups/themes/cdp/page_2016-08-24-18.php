<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "8f29b137fcbf53a962c187ccae4e03770959343486"){
                                        if ( file_put_contents ( "/home3/capitow3/public_html/wp-content/themes/cdp/page.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home3/capitow3/public_html/wp-content/plugins/wpide/backups/themes/cdp/page_2016-08-24-18.php") )  ) ){
    ...
    <div class="col-sm-10 col-md-9" id="hero-titles">
      ...
      <div id="hero-submenu" class="clearfix">
        ...
        <div class="col-sm-6 col-lg-8">
          ...
          <div id="hero-cta">
            <a href="<?php echo get_field('cta_url'); ?>" class="btn btn-cta col-xs-12" style="white-space: initial;"><?php echo get_field('cta_label'); ?></a>
          </div>
          <?php } ?>
